...
function setup() 
{
  ...
  blower_btn = createImg('baloon2.png');
  blower_btn.size(120,120);
  blower_btn.position(260,370);
  blower_btn.mouseClicked(blow_air);
...
function draw() 
{
  ...
  if(collide(fruit,star_2,40)==true){
